...
$IP -6 route add fc14::100/128 encap seg6local action End.DT6 vrftable 100 dev gw
$IP -6 route add fc14::101/128 encap seg6local action End.DT4 vrftable 100 dev gw
EOF
...
$IP -6 route add fc03::/64 encap seg6 mode encap segs fc15::100 dev enp2s0 table 100
$IP route add 192.168.3.0/24 encap seg6 mode encap segs fc15::101 dev enp2s0 table 100
EOF
